...
------------------------------------------------------------------------
	-- Filger Movers Stuff Below (Credits to Sapz)
------------------------------------------------------------------------

local PlayerBuffs = CreateFrame("Frame","FilgerPlayerBuffs",UIParent)
PlayerBuffs:CreatePanel("Default",150,36,"CENTER", UIParent, "CENTER", -273, -65)
...
PlayerDebuffs:CreatePanel("Default",150,72,"CENTER", UIParent, "CENTER", -273, -145)
...
PlayerProccs:CreatePanel("Default",150,32,"CENTER", UIParent, "CENTER", -273, -243)
...
PlayerHealBuffs:CreatePanel("Default",150,32,"CENTER", UIParent, "CENTER", -273, -16)
...
TargetDebuffs:CreatePanel("Default",150,36,"CENTER", UIParent, "CENTER", 273, -136)
...
TargetHeals:CreatePanel("Default",150,32,"CENTER", UIParent, "CENTER", 273, -136)
...
PvPBuffs:CreatePanel("Default",150,72,"CENTER", UIParent, "CENTER", 273, -75)
