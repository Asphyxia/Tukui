...
local function Shared(self, unit)
	...
	if (unit == "player" or unit == "target") then
		...
		if (C["unitframes"].charportrait == true) then
			...
			portrait:SetWidth(246)
			portrait:SetAlpha(1)
			if unit == "player" then
				portrait:SetPoint("TOP", health, "BOTTOM", 0, -28)
			elseif unit == "target" then
				portrait:SetPoint("TOP", health, "BOTTOM", 0, -28)
			end
		...
		if (unit == "player") then
			...
			if T.level ~= MAX_PLAYER_LEVEL then
				...
				Experience:Size(TukuiPlayer:GetWidth() +246, 12)
			...
			if T.level == MAX_PLAYER_LEVEL then
				...
				Reputation:Size(TukuiPlayer:GetWidth() +246, 12)
		...
		if C["unitframes"].combatfeedback == true then
			...
			CombatFeedbackText = T.SetFontString(health, font, 10, "THINOUTLINE")
...
if T.lowversion then
	tot:SetPoint("RIGHT", target, "LEFT", -69, 5)
	tot:Size(186, 18)
else
	tot:SetPoint("RIGHT", target, "LEFT", -69, 5)
	tot:Size(129, 36)
