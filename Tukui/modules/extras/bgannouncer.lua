...
button1_text:SetText(T.datacolor.."Low")
...
button2_text:SetText(T.datacolor.."Med")
...
button3_text:SetText(T.datacolor.."High")
...
button4_text:SetText(T.datacolor.."Secure")
...
button5_text:SetText(T.datacolor.."Focus")
...
button6_text:SetText(T.datacolor.."Hidden")
